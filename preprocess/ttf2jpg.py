...
def main():
    ...
    for _, _, ttfs in os.walk(ttf_dir):
        for ttf in ttfs:
            ttf_out_dir = os.path.join(jpg_dir, ttf.split(".")[0])
            if not os.path.exists(ttf_out_dir):
                os.makedirs(ttf_out_dir)
            ...
            for c in charset:
                ...
                if img:
                    ...
                    img.save(os.path.join(ttf_out_dir, '{}.jpg'.format(hex(ord(c))[2:])))
